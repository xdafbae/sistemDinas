    ...
    <div class="collapse navbar-collapse w-auto h-auto max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->hasAnyRole(['operator', 'superadmin']))
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('operator.perjalanan-dinas.create') ? 'active' : '' }}"
                        href="{{ route('operator.perjalanan-dinas.create') }}">
                        <div
                            class="icon icon-shape icon-sm text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if (Auth::user()->hasAnyRole(['operator', 'superadmin']))
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('operator.perjalanan-dinas.index') ? 'active' : '' }}"
                        href="{{ route('operator.perjalanan-dinas.index') }}">
                        <div
                            class="icon icon-shape icon-sm text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-fat-add text-info text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Pengajuan Perjalanan Dinas</span>
                    </a>
                </li>
            @endif
            ...
            @if (Auth::user()->hasAnyRole(['verifikator', 'superadmin']))
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('verifikator.perjalanan-dinas.index') ? 'active' : '' }}"
                        href="{{ route('verifikator.perjalanan-dinas.index') }}">
                        <div
                            class="icon icon-shape icon-sm text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if (Auth::user()->hasAnyRole(['operator', 'superadmin', 'atasan']))
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('spt.index') ? 'active' : '' }}"
                        href="{{ route('laporan.spt.index') }}">
                        <div
                            class="icon icon-shape icon-sm text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-check-bold text-warning text-sm opacity-10"></i>
                        </div>
            ...
            @if (Auth::user()->hasAnyRole(['atasan', 'kepala dinas', 'superadmin']))
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('atasan.perjalanan-dinas.index') ? 'active' : '' }}"
                        href="{{ route('atasan.perjalanan-dinas.index') }}">
                        <div
                            class="icon icon-shape icon-sm text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @auth
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('dokumen.index') ? 'active' : '' }}"
            ...
            @hasanyrole('verifikator|superadmin')
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('verifikator.laporan-perjadin.*') ? 'active' : '' }}"
                        href="{{ route('verifikator.laporan-perjadin.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-book-bookmark text-purple text-sm opacity-10"></i> {{-- Ikon berbeda --}}
                        </div>
                        <span class="nav-link-text ms-1">Verifikasi Laporan Perjadin</span>
                    </a>
                </li>
            @endhasanyrole

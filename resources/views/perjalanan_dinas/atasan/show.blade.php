...
@section('page_name', 'Persetujuan: ' . $perjalananDinas->nomor_spt)
        ...
        <div class="col-lg-10 col-md-12 mx-auto">
            <div class="card my-4">
                ...
                <div class="card-body px-4 pb-3">
                    {{-- Tampilkan semua detail perjalanan dinas --}}
                    <h5>Informasi SPT</h5>
                    ...
                    <h5 class="mt-3">Form Persetujuan</h5>
                    <form action="{{ route('atasan.perjalanan-dinas.process', $perjalananDinas->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" name="aksi_persetujuan" value="setuju" class="btn btn-success">Setujui Perjalanan Dinas</button>
                        </div>
                    </form>

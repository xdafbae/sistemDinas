            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Form Pengajuan Perjalanan Dinas</h6>
                    </div>
                </div>
                <div class="card-body px-4 pb-3">
                    ...
                    <form action="{{ route('operator.perjalanan-dinas.store') }}" method="POST" id="form-perjalanan-dinas">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_spt') is-invalid @enderror" id="tanggal_spt" name="tanggal_spt" value="{{ old('tanggal_spt', date('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('jenis_spt') is-invalid @enderror" id="jenis_spt" name="jenis_spt" required>
                                    ...
                                    <option value="dalam_daerah" {{ old('jenis_spt') == 'dalam_daerah' ? 'selected' : '' }}>Dalam Daerah (Kabupaten Siak > 8 Jam)</option>
                                    <option value="luar_daerah_dalam_provinsi" {{ old('jenis_spt') == 'luar_daerah_dalam_provinsi' ? 'selected' : '' }}>Luar Daerah (Dalam Provinsi Riau)</option>
                                    <option value="luar_daerah_luar_provinsi" {{ old('jenis_spt') == 'luar_daerah_luar_provinsi' ? 'selected' : '' }}>Luar Daerah (Luar Provinsi Riau)</option>
                                </select>
                        ...
                        <div class="row">
                             <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('jenis_kegiatan') is-invalid @enderror" id="jenis_kegiatan" name="jenis_kegiatan" value="{{ old('jenis_kegiatan', 'Biasa') }}" placeholder="Misal: Biasa, Diklat, Konsultasi, Survey" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('tujuan_spt') is-invalid @enderror" id="tujuan_spt" name="tujuan_spt" value="{{ old('tujuan_spt') }}" placeholder="Nama tempat atau instansi yang dituju" required>
                                @error('tujuan_spt') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                        </div>

                        {{-- Lokasi Tujuan untuk SBU --}}
                        <div class="row" id="lokasi-tujuan-sbu-group">
                            ...
                            <div class="col-md-6 mb-3" id="kota-tujuan-group" style="display:none;">
                                ...
                                <input type="text" class="form-control @error('kota_tujuan_id') is-invalid @enderror" id="kota_tujuan_id" name="kota_tujuan_id" value="{{ old('kota_tujuan_id') }}" placeholder="Nama kota/kab. jika SBU spesifik">
                        ...
                        <div class="row" id="transportasi-internal-group" style="display:none;">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('kecamatan_tujuan_id') is-invalid @enderror" id="kecamatan_tujuan_id" name="kecamatan_tujuan_id" value="{{ old('kecamatan_tujuan_id') }}" placeholder="Nama Kecamatan">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('desa_tujuan_id') is-invalid @enderror" id="desa_tujuan_id" name="desa_tujuan_id" value="{{ old('desa_tujuan_id') }}" placeholder="Nama Desa/Kampung">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('jarak_km') is-invalid @enderror" id="jarak_km" name="jarak_km" value="{{ old('jarak_km') }}" placeholder="Estimasi Jarak PP">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('dasar_spt') is-invalid @enderror" id="dasar_spt" name="dasar_spt" rows="3" placeholder="Contoh:
1. Undangan Rapat Nomor XXX Tanggal YYY
2. Disposisi Kepala Dinas" required>{{ old('dasar_spt') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('uraian_spt') is-invalid @enderror" id="uraian_spt" name="uraian_spt" rows="3" placeholder="Detail maksud dan tujuan perjalanan dinas" required>{{ old('uraian_spt') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="ya" id="opsi_transportasi_udara" name="opsi_transportasi_udara" {{ old('opsi_transportasi_udara') == 'ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="opsi_transportasi_udara">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="ya" id="opsi_transportasi_darat_antar_kota" name="opsi_transportasi_darat_antar_kota" {{ old('opsi_transportasi_darat_antar_kota') == 'ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="opsi_transportasi_darat_antar_kota">
                                        Transportasi Darat Antar Kota (SBU)
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select select2-multiple @error('personil_ids') is-invalid @enderror @error('personil_ids.*') is-invalid @enderror" id="personil_ids" name="personil_ids[]" multiple="multiple" required>
                                @foreach ($users ?? [] as $user)
                                    <option value="{{ $user->id }}" {{ (is_array(old('personil_ids')) && in_array($user->id, old('personil_ids', []))) ? 'selected' : '' }}>
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary" id="btn-submit-pengajuan">Ajukan & Generate Estimasi</button>
                        </div>
                    </form>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            function initSelect2(selector, placeholderText, allowClearOption = false) {
                $(selector).select2({
                    theme: "bootstrap-5",
                    placeholder: placeholderText,
                    allowClear: allowClearOption,
                    width: '100%',
                });
            }
